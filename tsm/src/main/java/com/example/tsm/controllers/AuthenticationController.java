...
import com.example.tsm.dtos.AuthenticationRequest;
import com.example.tsm.dtos.AuthenticationResponse;
import com.example.tsm.services.jwt.UserDetailsServiceImpl;
import com.example.tsm.utils.JwtUtil;
...
public class AuthenticationController {
    ...
    public AuthenticationResponse createAuthenticationToken(@RequestBody AuthenticationRequest authenticationRequest, HttpServletResponse response) throws BadCredentialsException, DisabledException, UsernameNotFoundException, IOException {
        try{
            ...
            response.sendError(HttpServletResponse.SC_NOT_FOUND,"User is not found. Register user first");
            return null;
        }
